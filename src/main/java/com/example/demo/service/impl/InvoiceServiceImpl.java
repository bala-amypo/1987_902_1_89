...
public class InvoiceServiceImpl implements InvoiceService {
    ...
    private final InvoiceCategorizationEngine invoiceCategorizationEngine;
    
    public InvoiceServiceImpl(InvoiceRepository invoiceRepository, 
                             UserRepository userRepository,
                             VendorRepository vendorRepository,
                             CategorizationRuleRepository categorizationRuleRepository,
                             InvoiceCategorizationEngine invoiceCategorizationEngine) {
    ...
    public Invoice categorizeInvoice(Long invoiceId) {
        ...
        List<CategorizationRule> rules = categorizationRuleRepository
